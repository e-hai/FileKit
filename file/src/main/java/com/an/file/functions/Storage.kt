...
interface Storage {
    ...
    suspend fun queryPicture(offset: Int, limit: Int): List<MediaStoreData>

    suspend fun queryMovie(offset: Int, limit: Int): List<MediaStoreData>

    suspend fun queryMusic(offset: Int, limit: Int): List<MediaStoreData>
}